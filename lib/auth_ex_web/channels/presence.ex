defmodule AuthExWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule AuthEx.MyChannel do
        use AuthExWeb, :channel
        alias AuthEx.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :auth_ex,
                        pubsub_server: AuthEx.PubSub
end
